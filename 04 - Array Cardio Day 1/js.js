...
const fil = inventors.filter(inv => inv.year >= 1500 && inv.year < 1600);
console.table(fil);
// Array.prototype.map()
...
const live = inventors.reduce((total, inv) => total + (inv.passed - inv.year), 0);
console.log(live);
...
// const category = Array.from(document.querySelectorAll('.mw-category li a'));
// const de = category
